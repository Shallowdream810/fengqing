 ...
 * Generated at: 2019-10-23 11:32:18 UTC
...
public final class customer_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String bath = request.getContextPath();
      ...
      out.print(bath);
      out.write("/cust/saveInfo\" method=\"post\">\r\n");
      ...
      out.write("\t\t<input id=\"comname\" name=\"comname\"/><span id=\"msg1\"></span></td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr >\r\n");
      out.write("\t<td align=\"right\" bgcolor=\"#FAFAF1\" height=\"22\">公司联系人：</td>\r\n");
      out.write("\t<td  align='left' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\">\r\n");
      out.write("\t\t<input name=\"companyperson\"/></td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr >\r\n");
      out.write("\t<td align=\"right\" bgcolor=\"#FAFAF1\" height=\"22\">公司地址：</td>\r\n");
      out.write("\t<td  align='left' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\">\r\n");
      out.write("\t\t<input name=\"comaddress\" size=\"60\"/></td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr >\r\n");
      out.write("\t<td align=\"right\" bgcolor=\"#FAFAF1\" height=\"22\">联系电话：</td>\r\n");
      out.write("\t<td  align='left' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\">\r\n");
      out.write("\t\t<input id=\"comphone\" name=\"comphone\"/><span id=\"msg2\"></span></td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr >\r\n");
      out.write("\t<td align=\"right\" bgcolor=\"#FAFAF1\" height=\"22\">座机：</td>\r\n");
      out.write("\t<td  align='left' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\">\r\n");
      out.write("\t\t<input name=\"camera\"/></td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr >\r\n");
      out.write("\t<td align=\"right\" bgcolor=\"#FAFAF1\" height=\"22\">公司简介：</td>\r\n");
      out.write("\t<td align='left' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\">\r\n");
      out.write("\t\t<textarea name=\"present\" rows=15 cols=130></textarea></td>\r\n");
      out.write("</tr>\r\n");
      out.write("\r\n");
      out.write("<tr >\r\n");
      ...
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("    $(\"#comname\").blur(function(){\r\n");
      out.write("        var comname = $(\"#comname\").val();\r\n");
      out.write("        if(comname == null || comname ==\"\")\r\n");
      out.write("        {\r\n");
      out.write("            $(\"#msg1\").text(\"公司名不能为空\").css(\"color\",\"red\");\r\n");
      out.write("            $(\"#comname\").focus();\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("        else{\r\n");
      out.write("            $(\"#msg1\").text(\"公司名称OK\").css(\"color\",\"green\");\r\n");
      out.write("            return true;\r\n");
      out.write("\t\t}\r\n");
      out.write("    })\r\n");
      out.write("    //手机号的非空，正则，唯一校验\r\n");
      out.write("    $(\"#comphone\").blur(function(){\r\n");
      out.write("        var comphone = $(\"#comphone\").val();\r\n");
      out.write("        //对同一个数据进行多种验证时，需要进行有顺序的去验证，先非空，再正则，唯一，若上面的不符合则直接退出整个事件\r\n");
      out.write("        if(comphone == null ||  comphone==\"\")\r\n");
      out.write("        {\r\n");
      out.write("            $(\"#msg2\").text(\"手机号不能为空\").css(\"color\",\"red\");\r\n");
      out.write("            $(\"#comphone\").focus();\r\n");
      out.write("            return true;\r\n");
      out.write("        }\r\n");
      out.write("        //手机号的正则校验\r\n");
      out.write("        if(!(/^1[3456789]\\d{9}$/.test(phone))){\r\n");
      out.write("            $(\"#msg2\").text(\"手机号格式不正确\").css(\"color\",\"red\");\r\n");
      out.write("            $(\"#comphone\").focus();//输入错误失焦\r\n");
      out.write("        }else{\r\n");
      out.write("            $(\"#msg2\").text(\"手机号OK\").css(\"color\",\"green\");\r\n");
      out.write("\r\n");
      out.write("\t\t}\r\n");
      out.write("    })\r\n");
      out.write("</script>\r\n");
