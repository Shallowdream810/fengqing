 ...
 * Generated at: 2019-10-29 10:27:44 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\ttype:\"get\",\r\n");
      out.write("\t\t\t\turl:\"not/findNotices\",\r\n");
      out.write("\t\t\t\tsuccess:function (msg) {\r\n");
      out.write("\t\t\t\t\tif (msg.map.statusCode == 200){\r\n");
      out.write("\t\t\t\t\t    $(msg.map.list).each(function (index,item) {\r\n");
      out.write("\t\t\t\t\t\t\tvar list = \"<li class='ue-clear'>\"\r\n");
      out.write("                                +\"<span>\"+moment(item.ndate).format(\"YYYY-MM-DD\")+\"</span>&nbsp;&nbsp;&nbsp;<a  href='javascript:findNotice(\"+item.nid+\")'class='notice-title'>\"+item.ntitle+\"</a>\"\r\n");
      out.write("                                +\"</li>\"\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#notice\").append(list);\r\n");
      out.write("                        })\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("                }\r\n");
      out.write("\t\t\t})\r\n");
      out.write("        })\r\n");
      out.write("\t\t// 打开\r\n");
      out.write("\t\tfunction findNotice(nid) {\r\n");
      out.write("\t\t\t$('#showdiv').show();  //显示弹窗\r\n");
      out.write("\t\t\t$('#cover').css('display','block'); //显示遮罩层\r\n");
      out.write("\t\t\t$(\"#cover\").css('height',document.body.clientHeight+'px'); //设置遮罩层的高度为当前页面高度\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\ttype:\"get\",\r\n");
      out.write("\t\t\t\t\turl:\"not/noticedetail/\"+nid,\r\n");
      out.write("\t\t\t\t\tsuccess:function (msg) {\r\n");
      ...
      out.write("            $('#showdiv').hide();  //隐藏弹窗\r\n");
      out.write("            $('#cover').css('display','none');   //显示遮罩层\r\n");
      out.write("        }\r\n");
      out.write("\t</script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("\t\t<tr bgcolor=\"#FFFFFF\">\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<ul id=\"notice\" class=\"notice-list\">\r\n");
      out.write("\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
      out.write("\r\n");
