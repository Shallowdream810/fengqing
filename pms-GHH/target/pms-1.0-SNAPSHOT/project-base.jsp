...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            success:function (msg) {
                $(msg).each(function (index,item) {
                        var str = "<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
        ...
        function detail(pid) {
            window.location.href="project-base-look.jsp";
        }
        function choseAll() {
